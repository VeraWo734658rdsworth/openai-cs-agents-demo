...
> **Personal fork note:** I'm using this to learn the Agents SDK and experiment with custom tools. Main changes from upstream are tracked in [CHANGES.md](CHANGES.md).
