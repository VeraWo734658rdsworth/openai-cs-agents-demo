...
# different agent behaviours without needing a real booking lookup.
# I default to "disrupted" because it exercises the most interesting agent paths
# (rebooking, voucher issuance, etc.) during local development.
